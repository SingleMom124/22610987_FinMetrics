...
Just USD global port

I shortened the time scale compared to the study as there was not a full year of data for 2023
...
```
 Estimate the portfolios. I do this with my function

```{r ports, message=FALSE, warning=FALSE}
