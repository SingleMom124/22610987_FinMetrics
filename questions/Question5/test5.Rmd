...
library(pacman)
p_load(rmsfuns, tidyverse, tbl2xts, devtools, PerformanceAnalytics, ggplot2, TTR, RcppRoll, xts, fmxdat)
...
First, look at whether the ZAR is indeed one of the most volatile currecnies over the past few years comparied to other currencies

To do this I am going to select 

Include a mix of G10 currencies (e.g., EUR, JPY, GBP) and emerging market currencies (e.g., BRL, MXN, TRY).
